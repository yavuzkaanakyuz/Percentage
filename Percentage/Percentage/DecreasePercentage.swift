...
struct DecreasePercentage: View {
...
struct InfoViewDecrease: View {
    var body: some View {
        VStack {
            Text("Yüzdelik Azaltma")
                .font(.title)
                .fontWeight(.bold)
                .padding(.bottom, 20)
            
            Text("Yüzdelik azaltma, bir sayının istenilen yüzdelik miktar kadar azaltılmasını sağlar.")
                .font(.body)
...
struct DecreasePercentage_Previews: PreviewProvider {
