...
struct IncreasePercentage: View {
...
struct InfoViewIncrease: View {
    var body: some View {
        VStack {
            ...
            Text("Yüzdelik artırma, bir sayını istenilen yüzdelik miktar kadar artırılmasını sağlar.")
                .font(.body)
...
struct IncreasePercentage_Previews: PreviewProvider {
